...
class _Error404pageState extends State<Error404page> {
  void _volverMenu() => Navigator.of(context).pop();
    ...
    return CustomAppBar(
      ...
      children: [
        ...
        const ListTile(
          ...
          subtitle: Text("Este sitio se encuentra en desarrollo",
        ...
        ElevatedButton(
          style:
              ElevatedButton.styleFrom(elevation: 8.0, primary: Colors.green),
